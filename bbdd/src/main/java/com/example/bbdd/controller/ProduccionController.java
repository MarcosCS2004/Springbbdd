...
public class ProduccionController {
    ...
    @GetMapping("/agregarProduccion")
    public String agregarProduccion(Model model) {
        List<Clasificacion> clasificacionList = daoService.listaCategorias();
        for (Clasificacion clasificacion : clasificacionList) {
            System.out.println("ID: " + clasificacion.getId_clasificacion() + ", Nombre: " + clasificacion.getName_clasificacion());
        }
        model.addAttribute("listaclasificacion", clasificacionList);
        return "agregarProduccion";
    }
